...
public class GariahatFragment extends Fragment implements OnMapReadyCallback{
    MapView mMapView;
    private GoogleMap googleMap;

    private static final String URL = "https://shayongupta.000webhostapp.com/partnerapp/gariahat.php";
