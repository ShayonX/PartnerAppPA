...
public class ScienceCityParkingLot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_city_parking_lot);

        sciencecity_btn = (Button) findViewById(R.id.sciencecity_btn);
        ...
        sciencecity_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                adapter.notifyDataSetChanged();
                sciencecity_btn.setEnabled(false);
    ...
    private Runnable mUpdateTimeTask = new Runnable() {
        public void run() {
            ...
            Intent it = new Intent(ScienceCityParkingLot.this, BillParking.class).putExtra(EXTRA_MESSAGE,billing);
            startActivity(it);
