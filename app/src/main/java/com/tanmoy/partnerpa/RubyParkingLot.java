...
public class RubyParkingLot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ruby_parking_lot);
    ...
    private Runnable mUpdateTimeTask = new Runnable() {
        public void run() {
            ...
            Intent it = new Intent(RubyParkingLot.this, BillParking.class).putExtra(EXTRA_MESSAGE,billing);
            startActivity(it);
