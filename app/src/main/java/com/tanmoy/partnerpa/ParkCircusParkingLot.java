...
public class ParkCircusParkingLot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_park_circus_parking_lot);

        park_circus_btn = (Button) findViewById(R.id.park_circus);
        ...
        park_circus_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                adapter.notifyDataSetChanged();
                park_circus_btn.setEnabled(false);
    ...
    private Runnable mUpdateTimeTask = new Runnable() {
        public void run() {
            ...
            Intent it = new Intent(ParkCircusParkingLot.this, BillParking.class).putExtra(EXTRA_MESSAGE,billing);
            startActivity(it);
