...
public class KasbaParkingLot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kasba_parking_lot);

        Show_ruby_btn = (Button) findViewById(R.id.Show_ruby_btn);
        ...
        Show_ruby_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                adapter.notifyDataSetChanged();
                Show_ruby_btn.setEnabled(false);
    ...
    private Runnable mUpdateTimeTask = new Runnable() {
        public void run() {
            ...
            Intent it = new Intent(KasbaParkingLot.this, BillParking.class).putExtra(EXTRA_MESSAGE,billing);
            startActivity(it);
